...
<aside class="sidebar-nav-wrapper">
    ...
    <nav class="sidebar-nav">
        <ul>
            <li class="nav-item @if(request()->route()->getName() == 'admin.dashboard.index') bg-light @endif">
                <a href="{{route('admin.dashboard.index')}}">
            ...
            <li class="nav-item nav-item-has-children ">
                <a
                    href="#0"
                    class="collapsed @if(str_contains(request()->route()->getName(), 'admin.video')) bg-light @endif"
              ...
              <span class="icon">
                ...
                <ul id="ddmenu_2" class="collapse dropdown-nav">
                    <li>
                        <a href="{{route('admin.video.list')}}"> List </a>
                    </li>
                    <li>
                        <a href="{{route('admin.video.create')}}"> Create </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item">
    ...
    <footer class="footer border-top">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 order-last order-md-first">
                    <div class="copyright text-center text-md-start">
                        <p class="text-sm">
                            Support by
                            <a
                                href="https://github.com/FurqatMashrabjonov"
                                rel="nofollow"
                                target="_blank"
                            >
                                Furqat Mashrabjonov
                ...
                "
                    >
                        <a onclick="return false" class="text-sm">Version: {{env('APP_VERSION')}}</a>
                    </div>
                </div>
            </div>
            <!-- end row -->
